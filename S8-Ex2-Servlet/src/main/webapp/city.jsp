...
<%@ page import="ch.hearc.heg.scl.tools.Utils" %><%--
...
<div class="container">
    ...
    <div class="row">
        <div class="col text-center">
            ...
            <a href="refresh?idCity=<%= v.getNumero() %>" role="button" class="btn btn-success"><i class="bi bi-arrow-clockwise"></i> Récupérer la dernière mesure</a>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <table class="table table-striped">
                ...
                <tr>
                    <td class="text-center"><%= Utils.formatDate(m.getDate()) %></td>
